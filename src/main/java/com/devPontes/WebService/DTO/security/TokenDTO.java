package com.devPontes.WebService.DTO.security;
...
public class TokenDTO implements Serializable{
	...
	public String toString() {
		return "TokenDTO [username=" + username + ", authenticated=" + authenticated + ", created=" + created
				+ ", expiration=" + expiration + ", accessToken=" + accessToken + ", refreshToken=" + refreshToken
				+ "]";
	}
